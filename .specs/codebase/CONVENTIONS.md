...
```
1. Update main locally: git fetch origin && git checkout main && git pull origin main
2. Create new branch: git checkout -b <type>/<name>
3. Make changes and commit to the new branch
4. Push to origin: git push -u origin <type>/<name>
5. Create Pull Request on GitHub
6. Get reviewed and approved
7. Merge PR (squash or merge, never direct push)
8. Delete feature branch after merge
```

**Examples of valid branch names:**
- ✅ `feature/add-reggae-cadences`
- ✅ `fix/harmony-calculation-bug`
- ✅ `docs/tlc-sdd-setup`
- ✅ `chore/update-dependencies`
- ❌ `main` (commits here = violation!)
- ❌ Direct push to main (forbidden)

**Enforcement:**
- `main` is protected (no direct pushes allowed)
- GitHub Actions will block commits to `main` without PR
- Any changes to `main` must come from merged PRs only
- Rebase or squash before merge (clean history)

**Why this matters:**
- Keeps production-ready code clean
- Enables code review for all changes
- Prevents accidental commits
- Maintains traceability via PRs
